 ...
 * ジャンボトロンの背景画像
 */
add_action('admin_menu', 'sutara79_jumbotron');

function sutara79_jumbotron() {
    add_options_page('ジャンボトロン', 'ジャンボトロン', 'manage_options', 'jumbotron-img-menu', 'sutara79_jumbotron_menu_page');
    add_action('admin_init', 'sutara79_register_jumbotron');
}

function sutara79_register_jumbotron() {
    register_setting('jumbotron-img-group', 'jumbotron-img');
    register_setting('jumbotron-img-group', 'jumbotron-position');
}

function sutara79_jumbotron_menu_page() {
?>
    <div class="wrap">
        <h1>ジャンボトロン</h1>
